"""LicenseGate — feature entitlement checker for Claude Swarm.
...
Usage:
    from swarm.licensing import license_gate

    # Imperative check
    license_gate.gate("std.swarm.advanced")

    # Decorator
    @license_gate.require_feature("std.swarm.enterprise")
...
_FEATURE_TIER_MAP = {
    # Pro (Tier 2)
    "std.swarm.advanced": ("Swarm Advanced Orchestration", "Pro"),
    # Enterprise (Tier 1)
    "std.swarm.enterprise": ("Swarm Enterprise Bridge", "Enterprise"),
}
