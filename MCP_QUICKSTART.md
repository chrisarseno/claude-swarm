...
```
C:/Users/chrisfromarose/.claude/mcp_settings.json
```
...
F:/projects/active/claude-swarm/examples/continuous_integration.yaml"
```
...
```
F:/projects/active/claude-swarm/config/swarm.yaml
```
